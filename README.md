...
- PersonalTrade is a clone of [TradeMaster](https://github.com/TradeMaster-NTU/TradeMaster), except for files in Tutorials
- PersonalTrade is for studying the basics of RL, and added tutorials are to hopefully make this goal more approachable
...
- [May16.ipynb](https://github.com/Louison5/PersonalTrade/blob/main/tutorial/May16.ipynb)
  ...
  - Understand each step of environment
  - Visualize the environment features
  - Get a random agent to run
  - Get a uniform agent for pre-experimentation
  - Write a naive LSTM agent and train

- [May18.ipynb](https://github.com/Louison5/PersonalTrade/blob/main/tutorial/May18.ipynb)
...
- [May27.ipynb](https://github.com/Louison5/PersonalTrade/blob/main/tutorial/May27.ipynb)
...
[PRUDEX-Compass: Towards Systematic Evaluation of Reinforcement Learning in Financial Markets](https://openreview.net/forum?id=JjbsIYOuNi) _(Transactions on Machine learning Research 2023)_

[Reinforcement Learning for Quantitative Trading (Survey)](https://dl.acm.org/doi/10.1145/3582560) _(ACM Transactions on Intelligent Systems and Technology 2023)_

[Deep Reinforcement Learning for Quantitative Trading: Challenges and Opportunities](https://ieeexplore.ieee.org/abstract/document/9779600) _(IEEE Intelligent Systems 2022)_

[DeepScalper: A Risk-Aware Reinforcement Learning Framework to Capture Fleeting Intraday Trading Opportunities](https://arxiv.org/abs/2201.09058) _(CIKM 2022)_

[Commission Fee is not Enough: A Hierarchical Reinforced Framework for Portfolio Management](https://ojs.aaai.org/index.php/AAAI/article/view/16142) _(AAAI 21)_
...
- [运筹 OR 帷幄][量化交易大师TradeMaster](https://mp.weixin.qq.com/s/bAuvKD5QD3Lz8ZC60WWJLQ)
